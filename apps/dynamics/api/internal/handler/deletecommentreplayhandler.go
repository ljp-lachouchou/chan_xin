...
// 删除评论回复
func deleteCommentReplayHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteCommentReplayReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewDeleteCommentReplayLogic(r.Context(), svcCtx)
		resp, err := l.DeleteCommentReplay(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
