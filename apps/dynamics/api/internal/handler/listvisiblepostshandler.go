...
// 浏览动态流
func listVisiblePostsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListVisiblePostsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewListVisiblePostsLogic(r.Context(), svcCtx)
		resp, err := l.ListVisiblePosts(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
