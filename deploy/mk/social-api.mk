...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=crpi-6tiftpwidsfx5hyi.cn-beijing.personal.cr.aliyuncs.com/chan-xin/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=chan-xin-${SERVER_NAME}-${SERVER_TYPE}-test
...
run-test:
	...
	./bin/${SERVER_NAME}-${SERVER_TYPE} -f ./apps/${SERVER_NAME}/${SERVER_TYPE}/etc/dev/${SERVER_NAME}.yaml
build-test:
